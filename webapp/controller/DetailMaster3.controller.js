sap.ui.define([
	...
	return Controller.extend("sap.ui.demo.fiori2.controller.DetailMaster3", {
		onInit: function () {
			...
			this.oRouter.getRoute("detailMaster3").attachPatternMatched(this._onProductMatched, this);
		},
		...
		_onProductMatched: function (oEvent) {
			...
			this.getView().getModel("detailData").setProperty("/DettaglioMaster3",[datiElementoSelect])
